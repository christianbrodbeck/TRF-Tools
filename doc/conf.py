# TRF-Tools documentation build configuration file, created as copy from Eelbrain
#
...
project = 'TRF-Tools'
copyright = f'{datetime.now().year}, Christian Brodbeck'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
# The short X.Y version. (appears in sidebar)
version = f"TRF-Tools {trftools.__version__}"
# The full version, including alpha/beta/rc tags.
release = trftools.__version__
...
modindex_common_prefix = ['trftools.']
