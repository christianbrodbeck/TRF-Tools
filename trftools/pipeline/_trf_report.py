...
def source_results(
    ...
    for ress_i in all_ress:
        ...
        panel = sp.plot_table(view='lateral', orientation='vertical', axw=layout.axw, dpi=layout.dpi, show=False)
        panels.append(panel)
...
def source_trfs(
    ...
    for key, res in ress.items():
        ...
        p = sp.plot_table(view='lateral', orientation='vertical', axh=1, show=False)
        trf_table.cell(p)
        p.close()
